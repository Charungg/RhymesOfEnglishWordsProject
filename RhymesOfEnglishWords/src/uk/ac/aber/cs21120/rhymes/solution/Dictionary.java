...
public class Dictionary implements IDictionary {
    ...
    public void addWord(IWord word) {
        // Checks if the passed word objects exist within the dictionary HashMap.
        // If it does exist then an argument will be thrown.
    ...
    public String removeComment(String line){
        ...
        if (indexOfComment != -1){
            ...
            return line.substring(0,indexOfComment-1);
        }
